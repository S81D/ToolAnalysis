...
T0Offset 25 # A timing offset (in clock ticks) that can be used to vary the pulse start times - it is primarily used to ensure the lognorm fits on the main peak avoid NaNs when sampling the fit params
...
TimeShift 0 # This is an artificial time shift to the MC Hits [ns] - as WCSim simulates particles from t0 = 0, this can be used as a toggle on the "trigger time"
